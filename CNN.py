...
modelSeq.fit(x_train, y_train, batch_size=64, epochs=10, verbose=2)
modelSeq.evaluate(x_test, y_test, batch_size=64, verbose=2)
...
modelFun.fit(x_train, y_train, batch_size=64, epochs=150, verbose=2)
modelFun.evaluate(x_test, y_test, batch_size=64, verbose=2)
